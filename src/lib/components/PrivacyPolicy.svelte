<div class="pb-20 lg:container lg:mx-auto">
	...
	<div class="border-y-2 xl:border-x-2 border-primary bg-secondary">
		...
		<div class="px-4 md:px-14 min-w-full bg-secondary text-secondary-content">
			<h2 class="text-2xl md:text-4xl py-10">Introduction</h2>

			<div class="md:px-4 text-base xs:text-lg md:text-xl space-y-5 pb-14">
				<p class="text-lg md:text-2xl font-bold">Last updated: March 14, 2022</p>
				<p>
				...
				<p>
					...
					This Privacy Policy has been created with the help of the Privacy Policy Template.
				</p>
			</div>
		</div>
		...
		<div class="px-4 md:px-14 min-w-full bg-secondary text-secondary-content">
			<h2 class="text-2xl md:text-4xl py-10">Interpretation and Definitions</h2>

			<div class="md:px-4 text-base xs:text-lg md:text-xl space-y-5 pb-14">
				<h3 class="text-lg md:text-2xl font-bold">Interpretation</h3>
				<p>
				...
				<h3 class="text-lg md:text-2xl font-bold">Definitions</h3>
				...
				<ul class="list-disc px-16">
					...
					<li>
						Application: the software program provided by the Company downloaded by You on any
						electronic device, named TravelSure
					</li>
					<li>
						Company: (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
						refers to AberTravel, Bell St, Dundee DD1 1HG.
					</li>
					<li>
					...
					<li>Website: refers to TravelSure, accessible from https://aber.travel/privacy</li>
					<li>
		...
		<div class="px-4 md:px-14 min-w-full bg-secondary text-secondary-content">
			<h2 class="text-2xl md:text-4xl py-10">Collecting and Using Your Personal Data</h2>

			<div class="md:px-4 text-base xs:text-lg md:text-xl space-y-5 pb-14">
				<h3 class="text-lg md:text-2xl font-bold">Types of Data Collected</h3>

				<h4 class="md:text-xl font-bold">Personal Data</h4>
				<p>
				...
				<h4 class="md:text-xl font-bold">Usage Data</h4>
				...
				<h4 class="md:text-xl font-bold">Tracking Technologies and Cookies</h4>
				...
				<p>
					...
					as soon as You close Your web browser. Learn more about cookies: Use of Cookies by Free
					Privacy Policy.
				</p>
				...
				<h3 class="text-lg md:text-2xl font-bold">Use of Your Personal Data</h3>
				...
				<ul class="list-disc px-16">
					...
					<li>You have purchased or of any other contract with Us through the Service.</li>
					<li>
				...
				<h3 class="text-lg md:text-2xl font-bold">Retention of Your Personal Data</h3>
				...
				<h3 class="text-lg md:text-2xl font-bold">Transfer of Your Personal Data</h3>
				...
				<h3 class="text-lg md:text-2xl font-bold">Disclosure of Your Personal Data</h3>

				<h4 class="md:text-xl font-bold">Business Transactions</h4>
				<p>
				...
				<h4 class="md:text-xl font-bold">Law enforcement</h4>
				<p>
				...
				<h4 class="md:text-xl font-bold">Other legal requirements</h4>
				<p>
				...
				<h3 class="text-lg md:text-2xl font-bold">Security of Your Personal Data</h3>
				<p>
		...
		<!-- Children's Privacy -->
		<div class="px-4 md:px-14 min-w-full bg-secondary text-secondary-content">
			<h2 class="text-2xl md:text-4xl py-10">Children's Privacy</h2>
		...
		<div class="px-4 md:px-14 min-w-full bg-secondary text-secondary-content">
			<h2 class="text-2xl md:text-4xl py-10">Links to Other Websites</h2>
		...
		<div class="px-4 md:px-14 min-w-full bg-secondary text-secondary-content">
			<h2 class="text-2xl md:text-4xl py-10">Changes to this Privacy Policy</h2>
		...
		<!-- Contact Us -->
		<div class="px-4 md:px-14 min-w-full bg-secondary text-secondary-content">
			<h2 class="text-2xl md:text-4xl py-10">Contact Us</h2>
			...
			<div class="md:px-4 text-base xs:text-lg md:text-xl space-y-5 pb-14">
				...
				<ul class="list-disc px-16">
					<li>
						By visiting this page on our website: https://aber.travel/user/contact (once logged in)
					</li>
					<li>
						By sendng an email (from a reputable mail source) to <a
							class="underline"
							href="mailto:travelsure-legal@aber.travel">travelsure-legal@aber.travel</a
						>
					</li>
				</ul>
			</div>
